...
my $cmd1 = "cargo run -- -vvv --p2p 127.0.0.1:6000 --api 127.0.0.1:7000 2> ./log/reg4_16.log";
my $cmd2 = "cargo run -- -vvv --p2p 127.0.0.1:6001 --api 127.0.0.1:7001 -c 127.0.0.1:6000";
my $cmd3 = "cargo run -- -vvv --p2p 127.0.0.1:6002 --api 127.0.0.1:7002 -c 127.0.0.1:6001 127.0.0.1:6000";
my $cmd4 = "cargo run -- -vvv --p2p 127.0.0.1:6003 --api 127.0.0.1:7003 -c 127.0.0.1:6002 127.0.0.1:6001";
my $cmd5 = "cargo run -- -vvv --p2p 127.0.0.1:6004 --api 127.0.0.1:7004 -c 127.0.0.1:6003 127.0.0.1:6002";
my $cmd6 = "cargo run -- -vvv --p2p 127.0.0.1:6005 --api 127.0.0.1:7005 -c 127.0.0.1:6004 127.0.0.1:6003";
my $cmd7 = "cargo run -- -vvv --p2p 127.0.0.1:6006 --api 127.0.0.1:7006 -c 127.0.0.1:6005 127.0.0.1:6004 127.0.0.1:6000";
my $cmd8 = "cargo run -- -vvv --p2p 127.0.0.1:6007 --api 127.0.0.1:7007 -c 127.0.0.1:6006 127.0.0.1:6005 127.0.0.1:6000 127.0.0.1:6001";
