...
my $cmd1 = "cargo run -- -vvv --p2p 127.0.0.1:6000 --api 127.0.0.1:7000 2> ./log/reg4_8.log";
...
my $cmd6 = "cargo run -- -vvv --p2p 127.0.0.1:6005 --api 127.0.0.1:7005 -c 127.0.0.1:6004 127.0.0.1:6003 &> /dev/null";
my $cmd7 = "cargo run -- -vvv --p2p 127.0.0.1:6006 --api 127.0.0.1:7006 -c 127.0.0.1:6005 127.0.0.1:6004 127.0.0.1:6000 &> /dev/null";
my $cmd8 = "cargo run -- -vvv --p2p 127.0.0.1:6007 --api 127.0.0.1:7007 -c 127.0.0.1:6006 127.0.0.1:6005 127.0.0.1:6000 127.0.0.1:6001 &> /dev/null";
