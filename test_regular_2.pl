...
my $cmd1 = "cargo run -- -vv --p2p 127.0.0.1:6000 --api 127.0.0.1:7000 2> ./log/reg2_64.log";
...
my $cmd8 = "cargo run -- -vv --p2p 127.0.0.1:6007 --api 127.0.0.1:7007 -c 127.0.0.1:6006 127.0.0.1:6000 &> /dev/null";
